...
@section('content')
    <div class="site-hero_2">
        <div class="page-title">
            <div class="big-title montserrat-text uppercase">{{ $category }}</div>
            <div class="small-title montserrat-text uppercase">home / category / {{ $category }}</div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($posts as $item)
                    <a href="/single/{{$item['id']}}" class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp animated"
